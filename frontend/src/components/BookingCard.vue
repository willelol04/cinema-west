    ...
    backgroundRepeat: 'no-repeat'
        ...
        <div class="booking-body" >
            ...
            <div class="booking-info">
                ...
                <span class="seats-info"><span class="seat-info" v-for="(ticket, ind) in booking.tickets">{{ ticket.seat.id }}<span v-if="ind < booking.tickets.length - 1">, </span></span></span>
            </div>
            <div class="booking-info">
            ...
            <button class="cancel-booking-button" @click="emits('delete')">Cancel booking</button>
        </div>
</template>
