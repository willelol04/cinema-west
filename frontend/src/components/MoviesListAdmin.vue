...
const addMovieUpdate = async (movie) => {
    try {
      ...
      errorToast("Error adding movie to database.")
    }
...
const deleteMovieUpdate = async (movie) => {
    try {
      if(confirm("Delete this movie?")) {
        ...
        errorToast("Error deleting movie from database.")
    }
...
<template>
    ...
    <div v-if="movies.length > display" class="scroll">
        ...
        <div class="movie-card" v-for="(movie, index) in visibleMovies" :key="movie.id">
            ...
            <div class="movie-actions">
                <button @click="addMovieUpdate(movie)" v-if="props.action=='add'" class="movie-action movie-add"><i class="pi pi-plus-circle"></i>Lägg till</button>
